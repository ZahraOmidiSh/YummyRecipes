 ...
 */
public abstract class Hilt_CollectionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CollectionFragment() {
    super();
  }

  Hilt_CollectionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CollectionFragment_GeneratedInjector) this.generatedComponent()).injectCollectionFragment(UnsafeCasts.<FavoriteFragment>unsafeCast(this));
    }
  }
