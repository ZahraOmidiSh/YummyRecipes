...
data class rrrr(
    ...
    data class Nutrition(
        ...
        data class CaloricBreakdown(
            ...
            val percentCarbs: Double?, // 59.15
            @SerializedName("percentFat")
            val percentFat: Double?, // 27.85
            @SerializedName("percentProtein")
            val percentProtein: Double? // 13.0
        )
        ...
        data class Ingredient(
            ...
            data class Nutrient(
                ...
                val percentOfDailyNeeds: Double?, // 28.06
                @SerializedName("unit")
                val unit: String? // g
            )
        }
        ...
        data class Nutrient(
            @SerializedName("amount")
            val amount: Double?, // 562.71
            @SerializedName("name")
            val name: String?, // Calories
            @SerializedName("percentOfDailyNeeds")
            val percentOfDailyNeeds: Double?, // 28.14
            @SerializedName("unit")
